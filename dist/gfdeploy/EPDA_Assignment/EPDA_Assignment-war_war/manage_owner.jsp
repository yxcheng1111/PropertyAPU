<%-- 
    ...
    Created on : Jul 9, 2023, 2:22:46 AM
    Author     : ASUS
--%>
    ...
    <body>
        ...
        <div class="section">
            <div class="container-fluid" style="padding-top: 80px;">
                    ...
                    <div class="row">
                        <div class="col text-end">
                            <div class="input-group">
                                ...
                                <span type="button" class="input-group-text" style="background-color: white; border: none; cursor: pointer;" onclick="window.location.href = 'Manage_User?role=owner&action=update_table&query=' + encodeURIComponent(document.getElementById('search').value)">
                ...
                <table id="ownerTable" class="table table-striped table-dark">
                    <thead>
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <form class="col" method="post" action="View_Rating">
                                        ...
                                        <button name="role"  value="owner" class="btn btn-primary"><ion-icon name="star"></ion-icon></ion-icon></button>
                                    </form>
                                    <form class="col" method="post" action="Manage_User">
                                        <input type="hidden" name="username" value="<%= username%>">
                                        <input type="hidden" name="action" value="staff_edit">
                                        <button name="role"  value="owner" class="btn btn-primary"><ion-icon name="create"></ion-icon></button>
                                    </form>
                                    <form class="col" method="post" action="Delete">            
                                        <input type="hidden" name="username" value="<%= username%>">
                                        <button name="action"  value="owner" class="btn btn-danger"><ion-icon name="trash"></ion-icon></button>                            
                                    </form>
                                </div>
                            </td>
                        </tr>
