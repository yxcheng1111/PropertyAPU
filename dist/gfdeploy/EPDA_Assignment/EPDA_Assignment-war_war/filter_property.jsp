<%-- 
    Document   : filter_property
    Created on : Jul 21, 2023, 9:57:52 AM
    Author     : ASUS
--%>
                ...
                <div class="container" style=" margin-top: 30px;">
                    <div class="col-12 col-sm-8 col-md-6 m-auto">
                        <div class="form-box p-3">
                            <div class="card-body">
                                <h2 style="font-size: 2em; color: white; text-align: center;">Filter Property</h2>
                                <form action="View_Property" method="POST" class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <select name="p_type" id="p_type" class="form-select" 
                                            ...
                                            <option value="" style="background: black;" disabled selected></option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="furnishing" id="furnishing" class="form-select" style="background: transparent; border: none; outline: none; font-size: 1em; color: white; border-radius: 0; border-bottom: 2px solid white;" >
                                            <option value="" style="background: black;" disabled selected></option>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="r_no" min="1" class="form-control" id="r_no" size="20" autocomplete="off" 
                                               style="background: transparent; border: none; outline: none; font-size: 1em; color: white; border-radius: 0; border-bottom: 2px solid white;">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="t_no" class="form-label" style="top: 50%; left: 5px; color: white; font-size: 1em;">Number of Toilets</label>
                                        <input type="number" name="t_no" min="1" class="form-control" id="t_no" size="20" autocomplete="off" 
                                               style="background: transparent; border: none; outline: none; font-size: 1em; color: white; border-radius: 0; border-bottom: 2px solid white;">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="f_size" class="form-label" style="top: 50%; left: 5px; color: white; font-size: 1em;">Floor Size(sq ft)</label>
                                        <input type="number" name="f_size" min="50" class="form-control" id="f_size" size="20" autocomplete="off"
                                               style="background: transparent; border: none; outline: none; font-size: 1em; color: white; border-radius: 0; border-bottom: 2px solid white;">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <label for="budget" class="form-label" style="top: 50%; left: 5px; color: white; font-size: 1em;">Budget</label>
                                        <input type="number" name="budget" class="form-control" id="r_price" size="20" autocomplete="off" min="0" 
                                               style="background: transparent; border: none; outline: none; font-size: 1em; color: white; border-radius: 0; border-bottom: 2px solid white;">
                                    </div>
                                    ...
                                    <div class="col" style="margin-top: 17px;">
                                        <div class="row">
                                            <div class="col">
                                                <input type="hidden" name="add_action" value="filter">
                                                <input type="hidden" name="action" value="<%=result%>">
                                                <button type="submit" style="border-radius: 10px;" class="w-100" style="border-radius: 40px;">Filter</button>
                                            </div>
                                            <div class="col" >
                                                <button type="button" style="border-radius: 10px;" onclick="window.location.href = 'View_Property?action=<%=result%>'" class="w-100" style="border-radius: 40px;">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
