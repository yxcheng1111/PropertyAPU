        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                if (e_validator.length() != 0 || p_validator.length() != 0) {
                    ...
                    RequestDispatcher dispatcher = request.getRequestDispatcher("Manage_User?role=" + role + "&action=staff_edit&username=" + username);
                    ...
                    if (role.equals("staff")) {
                        ...
                        request.setAttribute("updateMessage", "Update staff " +  username + " details successfully!!");
                        ...
                        request.setAttribute("updateMessage", "Update owner " + username + " details successfully!!");
                    } else {
                        ...
                        request.setAttribute("updateMessage", "Update customer " + username + " details successfully!!");
                    }
                    RequestDispatcher dispatcher = request.getRequestDispatcher("Manage_User?role=" + role + "&action=" + action);
                    dispatcher.forward(request, response);
